                        ...
                        <tbody>
                            ...
                            <?php foreach ($scan_pendukung_saya as $sps) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('user/file_download_scan_pendukung/' . $sps['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_scan_pendukung/' . $sps['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_scan_pendukung/' . $sps['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Upload Kerjasama</h3>
            </div>
