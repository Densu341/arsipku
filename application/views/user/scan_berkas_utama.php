                        ...
                        <tbody>
                            ...
                            <?php foreach ($scan_utama_saya as $sus) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('user/file_download_scan_utama/' . $sus['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_scan_utama/' . $sus['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_scan_utama/' . $sus['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Scan Berkas Utama</h3>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/scan_berkas_utama'); ?>
